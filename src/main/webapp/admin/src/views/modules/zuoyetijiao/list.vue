    ...
    <div v-if="showFlag">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="完成步骤">
		     <template slot-scope="scope">
                       {{scope.row.wanchengbuzhou}}
                     </template>
                </el-table-column>
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="zuoyeshipin"
                    header-align="center"
                    label="作业视频">
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click="download(scope.row.zuoyeshipin)">预览</el-button>
                    </template>
                  </el-table-column>
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="tijiaoshijian"
  ...
  methods: {
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          biaoti: row.biaoti,
          wanchengbuzhou: row.wanchengbuzhou,
          zuoyeshipin: row.zuoyeshipin,
