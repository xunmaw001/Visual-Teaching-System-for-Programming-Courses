<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="完成步骤" prop="wanchengbuzhou">
          <el-input v-model="ruleForm.wanchengbuzhou" 
              placeholder="完成步骤" clearable  :readonly="ro.wanchengbuzhou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="完成步骤" prop="wanchengbuzhou">
              <el-input v-model="ruleForm.wanchengbuzhou" 
                placeholder="完成步骤" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="作业视频" prop="zuoyeshipin">
          <file-upload
          tip="点击上传作业视频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.zuoyeshipin?ruleForm.zuoyeshipin:''"
          @change="zuoyeshipinUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.zuoyeshipin" label="作业视频" prop="zuoyeshipin">
            <el-button type="text" size="small" @click="download(ruleForm.zuoyeshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='wanchengbuzhou'){
            this.ruleForm.wanchengbuzhou = obj[o];
	    this.ro.wanchengbuzhou = true;
            continue;
          }
          if(o=='zuoyeshipin'){
            this.ruleForm.zuoyeshipin = obj[o];
	    this.ro.zuoyeshipin = true;
            continue;
          }
          if(o=='tijiaoshijian'){
    ...
    zuoyeshipinUploadChange(fileUrls) {
	this.ruleForm.zuoyeshipin = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
