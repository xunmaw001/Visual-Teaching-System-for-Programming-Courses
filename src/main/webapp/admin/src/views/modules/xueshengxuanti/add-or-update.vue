<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="选题时间" prop="xuantishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.xuantishijian" 
                type="datetime"
                placeholder="选题时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xuantishijian" label="选题时间" prop="xuantishijian">
              <el-input v-model="ruleForm.xuantishijian" 
                placeholder="选题时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="作业流程" prop="zuoyeliucheng">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zuoyeliucheng" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuoyeliucheng" label="作业流程" prop="zuoyeliucheng">
                    <span v-html="ruleForm.zuoyeliucheng"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.xuantishijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='zuoyeliucheng'){
            this.ruleForm.zuoyeliucheng = obj[o];
	    this.ro.zuoyeliucheng = true;
            continue;
          }
          if(o=='xuantishijian'){
            this.ruleForm.xuantishijian = obj[o];
	    this.ro.xuantishijian = true;
            continue;
          }
	...
	this.ruleForm.zuoyeliucheng = this.ruleForm.zuoyeliucheng.replace(reg,'../../../ssmti1mh/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
